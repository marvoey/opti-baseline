...
export const LINE_OF_BUSINESS: Record<string, TaxonomyEntry> = {
  "0": { displayName: "Personal Auto" },
  "1": { displayName: "Commercial Auto" },
  "2": { displayName: "Homeowners" },
  "3": { displayName: "Renters" },
  "4": { displayName: "Motorcycle / ATV" },
  "5": { displayName: "Boat / Watercraft" },
  "6": { displayName: "RV / Trailer" },
  "7": { displayName: "Umbrella Policy" },
};
