// Import ../handling-notes-home.json into Optimizely CMS as prgv_HandlingNoteBlock items.
//
// Usage:
//   node seed/scripts/import-handling-notes-home.mjs [--dry-run] [--concurrency=N] --container=<key>
//
...
const DATA_FILE = join(SEED_DIR, '..', 'handling-notes-home.json');
...
console.log(`Loaded ${items.length} item(s) from handling-notes-home.json`);
