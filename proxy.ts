...
export const config = {
  ...
  matcher: ['/((?!api|discovery-dev(?:/|$)|_next/static|_next/image|preview|kb-preview|cms-admin(?:/|$)|admin|util(?:/|$)|rationale(?:/|$)|demo-v2(?:/|$)|demo-flow(?:/|$)|demo(?:/|$)|kb(?:/|$)|search(?:/|$)|component-library(?:/|$)|favicon.ico|.*\\..*).*)'],
};
