...
const SUBCATEGORY_CHIPS = [
  ...
  { label: 'Office Desks', href: '/prototype/departments/furniture/home-office/office-desks' },
    ...
    <main>
      ...
      <section className="relative h-80 mt-4 flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-8 w-full">
          ...
          <Link
            href="/prototype/departments/furniture/home-office/office-desks"
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        ...
        <section className="pb-14">
          <div className="flex justify-between items-baseline mb-6">
            ...
            <Link href="/prototype/departments/furniture/home-office/office-desks" className="text-blue-700 text-sm font-semibold hover:underline">
