import type { ChromeData } from '@/lib/chrome';

/**
 * Site footer — wordmark + tagline, link columns, and a legal row. Data comes
 * from the CMS site settings (lib/chrome.ts), passed down by SiteChrome.
 */
const Footer = ({
  siteName,
  tagline,
  ...
  siteName: string;
  tagline: string;
  columns: ChromeData['footerColumns'];
  legal: string;
  legalLinks: ChromeData['footerLegalLinks'];
}) => (
