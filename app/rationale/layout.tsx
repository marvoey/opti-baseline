...
export const metadata: Metadata = {
  ...
  description: 'Understand the architecture and design decisions behind the Progressive × Optimizely CMS demo.',
...
export default function RationaleLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
