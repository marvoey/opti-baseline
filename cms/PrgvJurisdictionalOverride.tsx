...
export const PrgvJurisdictionalOverrideContentType = contentType({
  key: 'PrgvJurisdictionalOverride',
  baseType: '_component',
  compositionBehaviors: ['sectionEnabled', 'elementEnabled'],
  displayName: 'Progressive: Jurisdictional Override',
  description: 'What it is: State-specific modification to the Core Principle. Compliance role: Prevents quoting a National limit to a state customer — Jurisdiction detection replaces the national text with the state override.',
  properties: {
    InternalName: {
      type: 'string',
...
type Props = { content: ContentProps<typeof PrgvJurisdictionalOverrideContentType> };

export default function PrgvJurisdictionalOverride({ content }: Props) {
