...
export const PrgvStatutoryDisclosureContentType = contentType({
  key: 'PrgvStatutoryDisclosure',
  baseType: '_component',
  compositionBehaviors: ['sectionEnabled', 'elementEnabled'],
  displayName: 'Progressive: Statutory Disclosure',
  description: 'What it is: Mandatory legal language from state Departments of Insurance (DOI). Compliance role: Routed to the REQUIRED DISCLAIMER box in Resolve UI — must never be summarized or altered by the LLM.',
  properties: {
    InternalName: {
      type: 'string',
...
type Props = { content: ContentProps<typeof PrgvStatutoryDisclosureContentType> };

export default function PrgvStatutoryDisclosure({ content }: Props) {
